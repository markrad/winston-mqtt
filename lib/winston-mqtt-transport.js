...
const MqttTransport = winston.transports.MqttTransport = function MqttTransport(options) {
  ...
  this.requestTracer = options.requestTracer;
...
MqttTransport.prototype.log = function log(level, msg, meta, callback) {
  ...
  if (this.requestTracer && this.requestTracer.instance && this.requestTracer.property) {
    message.requestId = this.requestTracer.instance.get(this.requestTracer.property);
  }
